...
icon = Image.open(r"C:\Users\Naveen\Downloads\youtube-logo-png-hd-1.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By P Navin karthick",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *P Navin Karthick!*"""})
...
api_key = "AIzaSyA1OOMS5WL_0Oyc9gXVG5qqg4SO4-JYTDQ"
